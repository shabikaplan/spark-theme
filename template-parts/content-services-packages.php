<?php $section_image = get_field( 'package_section_image' ); ?>

<div class="row" style="background: url('<?php echo $section_image['url'] ?>') no-repeat right; background-size: 50%; filter: brightness(120%); opacity: 75%;">
	
	<div class="col-md-6 offset-md-3 text-center">
		<h4 class="section-heading"><?php the_field( 'package_section_heading' ); ?></h4>
		<?php the_field( 'package_section_body' ); ?>
	...
	<div class="col-md-7 text-center menu">
		...
		<?php if( have_rows( 'package_services' ) ): while( have_rows( 'package_services' ) ): the_row(); ?>
